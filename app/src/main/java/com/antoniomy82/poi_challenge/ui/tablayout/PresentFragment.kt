...
class PresentFragment(val poisViewModel: PoisViewModel) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mockNews.add(News("(MOCK) NOTICIA TOTAL","12 de Mayo de 2021", "12 MAY"))
        mockNews.add(News("(MOCK) FIESTA FINAL COVID","13 de Junio de 2022", "22 JUN"))

        context?.let { activity?.let { it1 ->
            poisViewModel.setPresentsRecyclerViewAdapter(mockNews, it,view,
                it1
            )
        } }
    }
